...
{/* 
    ...
    Task 1: Launch an EC2 Instance using Ubuntu OS
Connect to the Instance using SSH

Task 2: Install Nginx Server on EC2 Instance
Connect to the Nginx webpage using PublicIP

Task 3: Launch a New Instance using Amazon Linux
Connect to the Instance using Putty

Task 4: Launch an EC2 Instance using Windows OS
