...
/* The provided code is a React component named `App` that creates a chat interface for a virtual
assistant called SAHAAYAK. Here is an overview of what the code does: */
...
// // Replace the API key and endpoint with Gemini API's credentials and URL
// const API_KEY = "AIzaSyA_jNeo-p5wT_svV0QK6fUyzD_3yFVQ4Aw";
// const GEMINI_API_URL = "https://api.gemini.ai/v1/chat"; // Example API URL, replace with actual Gemini endpoint

// const systemMessage = {
//   role: "system",
//   content: "You are an assistant that provides career guidance based on user input."
// };
...
//         },
//         body: JSON.stringify({
//           model: "gemini-3", // Use the appropriate model ID provided by Gemini
//           messages: [
//             systemMessage,
//             ...newMessages.map((msg) => ({
//               role: msg.sender === "LEGALASSISTANT" ? "assistant" : "user",
//               content: msg.message
//             }))
//           ]
//         })
...
//       const data = await response.json();
//       const assistantResponse = data.response || data.message || "Sorry, I couldn't understand.";
...
//     if (lastMessage.sender === "LEGALASSISTANT") {
