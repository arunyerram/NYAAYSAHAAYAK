...
const API_KEY = "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";  // Replace with your actual Groq API key
...
function App() {
  ...
  const processMessageToChatBOT = async (chatMessages) => {
    ...
    try {
      const response = await fetch("https://api.groq.com/v1/chat/completions", {  // Update the endpoint as needed
        method: "POST",
        headers: {
          "Authorization": "Bearer " + API_KEY,
          "Content-Type": "application/json"
