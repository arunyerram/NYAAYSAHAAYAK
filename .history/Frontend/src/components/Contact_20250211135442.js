            ...
            <section style={{ padding: '40px', maxWidth: '800px', margin: 'auto', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <form onSubmit={handleSubmit} style={{ width: '100%', marginTop: '20px' }}>
                        ...
                        <button type="submit" style={{ marginTop: '15px', padding: '10px 20px', border: 'none', borderRadius: '5px', backgroundColor: '#007BFF', color: '', cursor: 'pointer' }}>Send Message</button>
                    </form>
                </div>
            </section>
