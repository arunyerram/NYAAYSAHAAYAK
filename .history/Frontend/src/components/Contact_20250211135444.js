...
//                                 <h4>Phone: <span>+91 9848427033 | +91 1234567899</span></h4>
//                             </div>
//                             <div className="info">
//                                 <i className="far fa-envelope"></i>
...
const Contact = () => {
    ...
    return (
        <>
            <section style={{ padding: '40px', maxWidth: '800px', margin: 'auto', textAlign: 'center' }}>
                <div>
                    <h2>Contact Us</h2>
                    <p>Feel free to reach out for any inquiries or support. We're here to help!</p>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{ textAlign: 'left', width: '100%' }}>
                        <h3>Contact Details</h3>
                        <p><strong>Phone:</strong> +91 9848427033 | +91 1234567899</p>
                        <p><strong>Email:</strong> nyaaysahaayak@info.com</p>
                        <p><strong>Address:</strong> KMIT, Hyderabad, Telangana, 500029</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} style={{ width: '100%', marginTop: '20px' }}>
                        ...
                        <button type="submit" style={{ marginTop: '15px', padding: '10px 20px', border: 'none', borderRadius: '5px', backgroundColor: '#007BFF', color: 'white', cursor: 'pointer' }}>Send Message</button>
                    </form>
                </div>
            </section>
